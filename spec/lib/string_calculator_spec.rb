  ...
  context "add" do
    ...
    context "it throws an exception for invalid input format" do
      it "raises an exception for '1,2,3a'" do
        expect { StringCalculator.add("1,2,3a") }.to raise_error(StringCalculator::Error, "invalid input format")
      end

      it "raises an exception for '//;\n1;;2;3'" do
        expect { StringCalculator.add("//;\n1;;2;3") }.to raise_error(StringCalculator::Error, "invalid input format")
      end
    end
  end
end
